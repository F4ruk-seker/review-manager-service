...
class BranchTestCase(APITestCase):
    url_create = reverse("api:branch_api:create")
    ...
    def test_update_branch(self):
        ...
        url_path = reverse("api:branch_api:update_destroy_retrieve", kwargs={'id': new_branch_id})
    ...
    def test_update_invalid_id_branch(self):
        ...
        url_path = reverse("api:branch_api:update_destroy_retrieve", kwargs={'id': invalid_id})
        response = self.client.put(url_path, self.temp_invalid_branch_data)
